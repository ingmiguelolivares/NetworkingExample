...
#pragma warning restore IDE1006 // restore naming rule violation check
        ...
        public List<NetworkMessageManager.MessageWithHandler> GetMessages()
        {
            ...
            // Unity 6000.6 can skip the generated initializer when this package is embedded
            // alongside Netcode for Entities. Keep a deterministic fallback so player builds
            // register the same built-in messages as the IL post-processor.
            if (__network_message_types.Count == 0)
            {
                RegisterBuiltInMessagesFallback();
            }
        ...
        private static NetworkMessageManager.MessageWithHandler CreateMessage<T>() where T : struct, INetworkMessage
        {
            return new NetworkMessageManager.MessageWithHandler
            {
                MessageType = typeof(T),
                Handler = NetworkMessageManager.ReceiveMessage<T>,
                GetVersion = NetworkMessageManager.CreateMessageAndGetVersion<T>
            };
        }

        private static void RegisterBuiltInMessagesFallback()
        {
            __network_message_types.Add(CreateMessage<ConnectionApprovedMessage>());
            __network_message_types.Add(CreateMessage<ConnectionRequestMessage>());
            __network_message_types.Add(CreateMessage<ChangeOwnershipMessage>());
            __network_message_types.Add(CreateMessage<ClientConnectedMessage>());
            __network_message_types.Add(CreateMessage<ClientDisconnectedMessage>());
            __network_message_types.Add(CreateMessage<ClientRpcMessage>());
            __network_message_types.Add(CreateMessage<CreateObjectMessage>());
            __network_message_types.Add(CreateMessage<DestroyObjectMessage>());
            __network_message_types.Add(CreateMessage<DisconnectReasonMessage>());
            __network_message_types.Add(CreateMessage<ForwardClientRpcMessage>());
            __network_message_types.Add(CreateMessage<ForwardServerRpcMessage>());
            __network_message_types.Add(CreateMessage<NamedMessage>());
            __network_message_types.Add(CreateMessage<NetworkTransformMessage>());
            __network_message_types.Add(CreateMessage<NetworkVariableDeltaMessage>());
            __network_message_types.Add(CreateMessage<ParentSyncMessage>());
            __network_message_types.Add(CreateMessage<ProxyMessage>());
            __network_message_types.Add(CreateMessage<RpcMessage>());
            __network_message_types.Add(CreateMessage<SceneEventMessage>());
            __network_message_types.Add(CreateMessage<ServerLogMessage>());
            __network_message_types.Add(CreateMessage<ServerRpcMessage>());
            __network_message_types.Add(CreateMessage<TimeSyncMessage>());
            __network_message_types.Add(CreateMessage<UnnamedMessage>());
            __network_message_types.Add(CreateMessage<SessionOwnerMessage>());
            __network_message_types.Add(CreateMessage<AnticipationCounterSyncPingMessage>());
            __network_message_types.Add(CreateMessage<AnticipationCounterSyncPongMessage>());
        }
